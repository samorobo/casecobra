            ...
            <Dropzone 
                ...
                > 
                    {({getRootProps, getInputProps}) => (
                        ...
                        {/* Checks if am image has been dragged(isDragOver is set to true) render 
                        the mouse icon else if its is isUploading then its false(hence isDragOver is et to false) then
                        render the Loader icon which would imply the image is still loading 
                        hence why isDragOver is still set to false , also  if no image has 
                        been dragged over and the isDragOver is till set to false then let the image icon be displayed */}
