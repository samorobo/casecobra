    ...
    <div className="relative grid grid-cols-1 lg:grid-cols-3 mt-20 mb-20 pb- 20">
            <div ref={containerRef}
             className="relative h-[37.5rem] overflow-hidden col-span-2 w-full max-w-4xl flex items-center justify-center rounded-lg border-2 border-dashed border-gray-300 p-12 text-center focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2">
                ...
                <Rnd 
                default={{x: 150, y: 250, height: imageDimensions.height/4, width: imageDimensions.width/4}}
                lockAspectRatio
                ...
                <div className="relative w-full h-full">
                    <NextImage src={imageUrl}  fill alt="pointer image" 
                      //sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
                            ...
                            <DropdownMenu>
                                ...
                                <DropdownMenuContent>
                                     {MODELS.options.map((model,i) => (
                                        <DropdownMenuItem key={i} className={cn("flex text-sm gap-1 items-center p-1.5 cursor-default hover:bg-zinc-100",{
